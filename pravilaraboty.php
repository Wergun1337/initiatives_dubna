...
<body>
    ...
    <main>
        <div class="pravila_cont">
            <div class="pp1"><h2>Правила работы</h2></div>
            <div class="pp1"><h3>Что нужно учесть в проекте инициативы</h3></div>
            <div class="pp2">
                <div><h3>Социальную значимость</h3></div>
                <div class="pp3"><p>Проект должен оказывать позитивное влияние на жизнь отдельного человека, группы людей или сообщества в целом. Стать рабочим инструментом по решению насущных проблем граждан.</p></div>
            </div>
            <div class="pp2">
                <div><h3>Актуальность для города</h3></div>
                <div class="pp3"><p>Проект должен способствовать созданию благоприятной среды по развитию территорий и общественных пространств города.</p></div>
            </div>
            <div class="pp2">
                <div><h3>Бюджет</h3></div>
                <div class="pp3"><p>Проекты, предполагающие софинансирование со стороны жителей или сторонних организаций, имеют приоритет.</p></div>
            </div>
        </div>
    </main>
    <?php
